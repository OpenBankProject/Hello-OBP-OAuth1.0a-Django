"""
Django settings for django_obp_oauth project.
...
SECRET_KEY = 'ac9n2yvbeetn^_!c9qkf8xx!hjrv9@^b9%bu*gvzgpo9yw*s30'
...
ROOT_URLCONF = 'django_obp_oauth.urls'

WSGI_APPLICATION = 'django_obp_oauth.wsgi.application'
